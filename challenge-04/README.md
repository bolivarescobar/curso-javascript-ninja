...
/* carro.adicionarPessoas = function(x) {
    ...
    carro.quantidadePessoas <= 5 ? true : false;
    ...
    if( carro.quantidadePessoas > carro.assentos ) {
        ...
        return "Só " + cabimento + " mais " + quantidadeCabem + " " + pessoa + "!";
        }
    }
...
carr.adicionarPessoas(10); // Só cabem mais 4 pessoas no carro!
