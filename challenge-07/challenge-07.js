...
while( newCounter <= 20 ) {
    newCounter % 2 !== 0 ? console.log(newCounter) : "";
    newCounter++;
}
...
for (var newContador = 111; newContador <= 125; newContador++) {
    newContador % 2 !== 0 ? console.log(newContador) : "";
}